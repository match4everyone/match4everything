...
from apps.matching_old.models import Newsletter, User
from apps.matching_old.forms import form_labels
from apps.matching_old.models import AUSBILDUNGS_TYPEN_COLUMNS, EmailToHospital, EmailToSend, Student
...
class DataBaseStats:
    ...
    @stat_count.register
    def deactivated_matching_old(self):
        return (
