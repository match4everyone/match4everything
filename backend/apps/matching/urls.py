...
from apps.matching.forms import StudentForm, StudentFormAndMail
from apps.matching.models import Student
from apps.matching.forms import HospitalFormInfoCreate, HospitalFormInfoSignUp
from apps.matching.models import Hospital
from django.views.generic.base import TemplateView
from django.urls import path, register_converter

from apps.matching.views import StudentSelectionView
...
urlpatterns = [   path("", views.index, name="index"),
    ...
    path(
        ...
        views.ParticipantSignupView.as_view(
            ...
            template_thanks_for_registering="/matching/thanks",
