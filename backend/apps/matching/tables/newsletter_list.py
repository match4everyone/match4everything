...
from apps.matching.models import Newsletter, NewsletterState
...
class NewsletterTable(tables.Table):
    ...
    def render_uuid(self, value):
        return format_html('<a href="/matching/view_newsletter/%s">Details</a>' % value)
    ...
    def render_letterapprovedby(self, value):
        return format_html('<a href="/matching/view_newsletter/%s">%s</a>' % (value, _("Ansehen")))
