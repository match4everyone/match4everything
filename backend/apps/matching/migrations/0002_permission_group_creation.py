...
class Migration(migrations.Migration):
    ...
    def create_groups(apps, schema_editor):
        # This is necessary, because the built-in permissions are only created AFTER a successful migration.
        # Thus, it is not enough to have the right dependencies, earlier migrations have to be finished completely
        # before attempting this one. The following line ensures this, also refer to:
        # https://code.djangoproject.com/ticket/23422 for more information.
        ...
        can_view_a = Permission.objects.get(codename="view_participanta") # This is a built-in permission
        group_can_view_a.permissions.add(can_view_a)

        can_view_b = Permission.objects.get(codename="view_participantb") # This is a built-in permission
