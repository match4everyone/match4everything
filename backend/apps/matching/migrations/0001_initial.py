# Generated by Django 3.0.5 on 2020-05-30 11:16
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='user',
            constraint=models.CheckConstraint(check=models.Q(('is_A', False), ('is_B', False), _negated=True), name='matching_user_has_only_one_participant'),
        ),
        migrations.AddConstraint(
            model_name='user',
            constraint=models.CheckConstraint(check=models.Q(('is_participant', True), ('is_staff', True), _negated=True), name='matching_user_only_staff_or_participant'),
        ),
        migrations.CreateModel(
