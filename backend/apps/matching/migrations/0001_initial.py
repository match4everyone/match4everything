...
import apps.matching.models.newsletter_approved_by
import apps.matching.models.student
import datetime
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('approval_code', models.IntegerField(default=apps.matching.models.newsletter_approved_by.random_number)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datenschutz_zugestimmt', models.BooleanField(default=False, validators=[apps.matching.models.student.validate_checkbox])),
                ('einwilligung_datenweitergabe', models.BooleanField(default=False, validators=[apps.matching.models.student.validate_checkbox])),
                ('einwilligung_agb', models.BooleanField(default=False, validators=[apps.matching.models.student.validate_checkbox])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('letter_approved_by', models.ManyToManyField(related_name='letter_approved_by', through='matching.LetterApprovedBy', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            ...
            name='newsletter',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='matching.Newsletter'),
        ),
        migrations.AddField(
            model_name='letterapprovedby',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='matching.EmailGroup')),
                ('hospital', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='matching.Hospital')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='matching.Student')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='hospital',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='matching.Hospital'),
        ),
    ]
