# Generated by Django 3.0.7 on 2020-06-26 09:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='participantinfolocationb',
            name='participant_info',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='location', to='matching.ParticipantInfoB'),
        ),
        migrations.AddField(
            model_name='participantinfolocationa',
            name='participant_info',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='location', to='matching.ParticipantInfoA'),
        ),
    ]
