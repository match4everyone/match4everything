...
from apps.matching_old.models import Student, User
from apps.matching_old.models.student import AUSBILDUNGS_IDS, AUSBILDUNGS_TYPEN
from apps.matching_old.web.buttongroup import RadioButtons
    ...
    def clean_email(self):
        ...
        if User.objects.filter(email=email).exists():
            raise ValidationError(
                mark_safe(
                    _(
                        'Diese E-mail ist bereits vergeben und eine Bestätigungsmail wurde versandt. <b><a target="_blank" href="/matching_old/resend_validation_email/'
                        + email
