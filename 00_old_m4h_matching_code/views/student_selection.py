...
from apps.matching_old.filters import StudentJobRequirementsFilter
from apps.matching_old.models import Student
from apps.matching_old.src.map import get_plzs_close_to, plzs
from apps.matching_old.tables import StudentSelectionTable, StudentTable
