...
from apps.matching_old.forms import NewsletterEditForm, NewsletterViewForm, TestMailForm
from apps.matching_old.models import LetterApprovedBy, Newsletter, NewsletterState
